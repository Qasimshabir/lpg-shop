...
-- ============================================
-- Run this after the main schema to add purchase history optimizations
...
DO $
BEGIN
  RAISE NOTICE '✅ Purchase history enhancements created successfully!';
  RAISE NOTICE '📊 Views created: customer_purchase_summary, product_purchase_history, monthly_sales_summary, customer_loyalty_metrics';
  RAISE NOTICE '🔧 Functions created: get_customer_purchase_history, get_sale_details, get_customer_product_preferences, get_purchase_history_by_date, calculate_customer_ltv';
END $;
